...
public class CommentsRecViewAdapter extends RecyclerView.Adapter<CommentsRecViewAdapter.CommentsViewHolder> {
    ...
    public CommentsRecViewAdapter(Activity activity, List<com.orchidatech.askandanswer.Database.Model.Comments> comments, View parent, OnLastListReachListener lastListReachListener, OnCommentOptionListener commentOptionListener) {
                    ...
                    pop.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                        ...
                        public boolean onMenuItemClick(MenuItem item) {
                            ...
                            if(id == R.id.edit_comment){
                                commentOptionListener.onEditComment(comments.get(position).getServerID(), holder.iv_comment.getDrawable());
                                return true;
                            }else if(id == R.id.delete_comment){
                                commentOptionListener.onDeleteComment(comments.get(position).getServerID(), position);
                                return true;
                            }
                            return false;
                        }
